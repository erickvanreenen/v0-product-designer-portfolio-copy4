    ...
    <div>
      <section className="bg-white">
        <div className="max-w-5xl mx-auto px-6 py-20 md:py-28">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#0F7353] tracking-tight mb-4">
            Projects
          </h1>
        ...
        {edtechProjects.length > 0 && (
          <div className="mt-24">
            <div className="border-t border-border pt-16 mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#0F7353] tracking-tight">
                EdTech
              </h2>
            </div>
            <div className="grid md:grid-cols-2 gap-16 md:gap-12">
