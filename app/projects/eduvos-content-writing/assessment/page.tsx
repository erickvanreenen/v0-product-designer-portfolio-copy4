    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-20 md:py-28">
        ...
        <section className="mb-24">
          <h2 className="text-3xl font-bold text-[#09332C] tracking-tight mb-6">Brief topic</h2>
          <p className="text-base text-foreground/70 leading-relaxed">
        ...
        {/* Scope */}
        <section className="mb-24">
          <h2 className="text-3xl font-bold text-[#09332C] tracking-tight mb-6">Scope</h2>
          <p className="text-base text-foreground/70 leading-relaxed">
        ...
        <section className="mb-24">
          <h2 className="text-3xl font-bold text-[#09332C] tracking-tight mb-10">Delivery requirements</h2>
        ...
        {/* Formative Exercises */}
        <section className="mb-24">
          <h2 className="text-3xl font-bold text-[#09332C] tracking-tight mb-2">Exercises and deliverables</h2>
          ...
          <div className="space-y-12">
            {exercises.map((ex) => (
              <div key={ex.label} className="bg-white rounded-lg p-8 md:p-10">
                ...
                <h3 className="text-xl font-bold text-[#09332C] tracking-tight mb-3">{ex.title}</h3>
        ...
        {/* Summative */}
        <section className="mb-24">
          <h2 className="text-3xl font-bold text-[#09332C] tracking-tight mb-2">Summative assessment</h2>
        ...
        <section className="mb-24">
          <h2 className="text-3xl font-bold text-[#09332C] tracking-tight mb-10">Minimum research requirements</h2>
          <div className="space-y-6">
            {[
