  ...
  return (
    <>
      ...
      <div className="relative">
        ...
        <div
          ref={scrollRef}
          className="flex gap-3 overflow-x-auto pb-4 scroll-smooth mx-5"
      ...
      {isOpen && lightboxIndex !== null && (
        ...
        >
          {/* Counter */}
          <p className="absolute top-5 left-5 text-xs text-white/50 font-medium tabular-nums z-10 pointer-events-none">
          ...
          {/* Image — rendered directly in the flex container so it sizes naturally */}
