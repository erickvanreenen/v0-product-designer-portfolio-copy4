      ...
      <div className="max-w-3xl mx-auto px-6 py-20 md:py-28">
        ...
        <section className="mb-24">
          <div className="flex items-center gap-3 mb-4">
              <LogoMark size={16} opacity={0.25} />
              <h2 className="text-3xl font-bold text-foreground tracking-tight">Consistent filtering system</h2>
            </div>
        ...
        <section className="mb-24">
          <div className="flex items-center gap-3 mb-4">
              <LogoMark size={16} opacity={0.25} />
              <h2 className="text-3xl font-bold text-foreground tracking-tight">Omnichannel collection options</h2>
            </div>
